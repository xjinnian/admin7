<template>
  <div class="q-pa-md">
    ...
    <q-dialog v-model="show_dialog_img_description" persistent>
      <ImgDescription :detail_obj="detail_obj" :key_type="KEY_TYPE_I18N_KEY" @emit-edit="handle_conform_edit"
...
import { api_i18nKey,api_imgDescription } from 'src/api/index.js'
...
import { KEY_TYPE_I18N_KEY } from 'src/config/key_type'
...
export default {
  ...
  methods: {
    ...
    async hadle_flush_imgdesc() {
      ...
      try {
        await api_imgDescription.handle_flush({key_type: KEY_TYPE_I18N_KEY})
      } catch (error) {}
      this.$lodash.delay(() => {
