/*
 * @FilePath: /client-api-doc-admin/src/pages/cssKey/config/index.js
 * @Description:
 */
...
export const columns = [
  ...
  { name: "group_id", align: "left", label: "CSS 属性组", field: "group_id" },
  {
    name: "project",
    align: "left",
    label: "布局模板",
  ...
  },
  {
    ...
    field: "level",
    format: (val) => {
      return config.options_css_level.find(v=>v.value==val)?.label
    }
  },
