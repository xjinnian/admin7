  ...
  <div class="q-pa-md">
    <div ref="tableHeader">
      ...
      <div class="row q-my-sm q-gutter-sm" v-if="show_search_form_area">
        ...
        />
        <q-checkbox
          v-model="search_form.exact_query"
          left-label
          label="精确查询"
        />
...
import { api_keyChangeRecord } from "src/api/index.js";
...
export default {
  ...
  data() {
    return {
      //API 命名空间
      api_namespace: api_keyChangeRecord,
      //列表 表格项配置
      columns,
      //编辑弹窗内的数据
      detail_obj: {
